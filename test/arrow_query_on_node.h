...
void test_arrow_query_on_node() {
  auto fnCheckArrow =
      [](const Arrow::List &arrows_, std::optional<std::string> source_,
         std::optional<std::string> target_, std::optional<std::string> name_) {
        auto it = std::find_if(arrows_.begin(), arrows_.end(),
